...
import { respiratoryCareList } from "../../components/productList/ProductList";
...
const RespiratoryCare = () => {
  ...
  useEffect(() => {
    setHerbalPowderProd(respiratoryCareList);
  }, []);
  return (
    <div>
      <Navbar />
      <div className="immuneBooster_sectionOneCont">
        <div className="immuneBooster_sectionOne_gen">
          <div className="pageHeading__">Respiratory Care</div>
          <a
