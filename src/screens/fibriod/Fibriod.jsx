...
import { fibriodList } from "../../components/productList/ProductList";
...
const Fibriod = () => {
  ...
  useEffect(() => {
    setHerbalPowderProd(fibriodList);
  }, []);
    ...
    <div>
      ...
      <div className="immuneBooster_sectionOneCont">
        <div className="immuneBooster_sectionOne_gen">
          <div className="pageHeading__">Fibriod</div>
          <a
