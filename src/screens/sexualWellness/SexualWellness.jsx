...
import "./sexualWellness.css";
import Navbar from "../../components/navbar/Navbar";
import Footer from "../../components/footer/Footer";
import { sexualWellnessList } from "../../components/productList/ProductList";
...
const SexualWellness = () => {
  ...
  useEffect(() => {
    setHerbalPowderProd(sexualWellnessList);
  }, []);
  return (
    <div>
      <Navbar />
      <div className="immuneBooster_sectionOneCont">
        <div className="immuneBooster_sectionOne_gen">
          <div className="pageHeading__">Sexual Wellness</div>
