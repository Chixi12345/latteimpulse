...
import "./immuneBooster.css";
import Navbar from "../../components/navbar/Navbar";
import Footer from "../../components/footer/Footer";
import SingleProductCard from "../../components/singleProductCard/SingleProductCard";
import { immuneBoosterList } from "../../components/productList/ProductList";
import { useLocation } from "react-router-dom";
import ProductImg from "../../components/productList/ProductImg";

const ImmuneBooster = () => {
  const [immuneProd, setImmuneProd] = useState([]);
  ...
  useEffect(() => {
    setImmuneProd(immuneBoosterList);
  }, []);
    ...
    <div>
      ...
      <div className="immuneBooster_sectionOneCont">
        <div className="immuneBooster_sectionOne_gen">
          <div className="pageHeading__">Immune Booster</div>
          <a
