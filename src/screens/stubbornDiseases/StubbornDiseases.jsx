...
import { stubbornDiseasesList } from "../../components/productList/ProductList";
import SingleProductCard from "../../components/singleProductCard/SingleProductCard";
import { useLocation } from "react-router-dom";
import ProductImg from "../../components/productList/ProductImg";

const StubbornDiseases = () => {
  ...
  useEffect(() => {
    setHerbalPowderProd(stubbornDiseasesList);
  }, []);
  return (
    <div>
      <Navbar />
      ...
      <div className="immuneBooster_sectionOneCont">
        <div className="immuneBooster_sectionOne_gen">
          <div className="pageHeading__">Stubborn Diseases</div>
          <a
...
export default StubbornDiseases;
