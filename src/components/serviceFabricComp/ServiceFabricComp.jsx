...
import "./serviceFabricComp.css";

const ServiceFabricComp = () => {
  return (
    <div className="serviceCategory_sectionOneCont">
      <div className="serviceCategory_sectionOne_gen">
        <div className="services_catergoryEach_mainPara">
          ...
          themselves – we also provide expert guidance and support every step of
...
export default ServiceFabricComp;
